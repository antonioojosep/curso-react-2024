...
const CardGitHub = (props) => {
  ...
  return (
    ...
    <div className="relative flex w-80 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md my-5">
      <div
        className="relative mx-4 mt-6 h-40 overflow-visible rounded-xl bg-clip-border
       text-white shadow-lg shadow-blue-500/40 bg-gradient-to-t from-blue-500 to-blue-900"
      >
        <img
          src={avatar_url}
          alt=""
      ...
      <div className="p-6 pt-0">
        ...
        font-sans text-sm font-bold uppercase text-white shadow-md shadow-blue-800/20 transition-all 
        hover:shadow-lg hover:shadow-blue-800/50"
        >
          Ir al GitHub
        </button>
      </div>
